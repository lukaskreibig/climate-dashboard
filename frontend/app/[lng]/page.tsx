  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // reader is already looking at the space where it should be. At low
        // priority and a couple at a time, so they queue behind the terrain
        // rather than racing it for the same connection. Measured on a 1.6 Mbit
        // line: the wait in front of the first photograph falls from about 7 s
        // to under 50 ms.
